...
(compare Fig. \ref{lst:jsq} and Fig. \ref{lst:rsjsq}).
...
If we take the processing of the tasks on the workers into account, we
...
out by the implementation (visualized in Fig. \ref{fig:algo:time} and
...
As each tick one task gets pushed into the set of workers, we get a constant
