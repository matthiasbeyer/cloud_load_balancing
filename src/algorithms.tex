...
Sample data in form of a CSV file was generated with \ref{lst:ruby}
...
the processing, \ac{JSQ} and \ac{RSJSQ} behave exactly like \ac{RR} as shown
in \ref{fig:algo:use} and \ref{fix:algo:use:defdev}.
...
out by the implementation (\ref{fig:algo:time} and \ref{fig:algo:time:defdev}).
